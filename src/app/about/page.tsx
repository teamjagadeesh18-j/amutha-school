...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#f7f8f9] text-[#475569] antialiased font-body">
      <SpatialHeader />
      <BreadcrumbSchema pageName="About" pageUrl="https://amuthamatric.edu.in/about" />
    ...
    <div className="bg-[#ffffff] border-b border-[#e2e8f0] py-3 px-6 text-xs text-[#64748b]">
      ...
      <section className="bg-[#0f172a] text-white py-16 px-6 relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto text-center relative z-10">
          <span className="inline-block px-3.5 py-1 rounded-full bg-[#5e6ad2] text-white text-xs font-semibold uppercase tracking-wider mb-4">
            ABOUT AMUTHA MATRICULATION SCHOOL
          </span>
      ...
      <section className="py-16 px-6 bg-[#ffffff]">
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="inline-block px-3.5 py-1 rounded-full bg-[#f1f5f9] text-[#5e6ad2] text-xs font-bold uppercase tracking-wide">
            ...
            <TextEffect as="h2" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-2xl md:text-4xl font-bold text-[#0f172a] font-heading leading-tight">
              A Beacon of Quality Education in Krishna Nagar
            </TextEffect>
            <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-base text-[#475569] leading-relaxed">
              Amutha Matriculation School was established to deliver comprehensive Tamil Nadu State Board education combined with disciplined character building, modern teaching methodologies, and individual care.
            </TextEffect>
            <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-base text-[#475569] leading-relaxed">
        ...
        <div className="max-w-[1200px] mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-[#e2e8f0] shadow-sm hover:shadow-md transition-shadow">
              <div className="w-12 h-12 rounded-xl bg-[#eeeffc] text-[#5e6ad2] flex items-center justify-center mb-6">
      ...
      <section className="py-16 px-6 bg-[#0f172a] text-white">
        <div className="max-w-[1000px] mx-auto bg-[#1e293b] p-8 md:p-12 rounded-3xl border border-[#334155] shadow-xl text-center space-y-6">
          <span className="inline-block px-3.5 py-1 rounded-full bg-[#5e6ad2]/20 text-white border border-[#5e6ad2]/40 text-xs font-semibold uppercase tracking-wider">
          ...
          <blockquote className="text-xl md:text-2xl font-serif italic text-[#f8fafc] leading-relaxed">
            "Education is the most powerful tool to transform character and society. At Amutha Matriculation School, we nurture every child with individual care, moral values, and academic strength."
          </blockquote>
          <div>
            ...
            <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-xs text-[#94a3b8]">Amutha Matriculation School, Krishna Nagar</TextEffect>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 bg-[#ffffff] border-t border-[#e2e8f0] text-center">
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <div className="pt-2">
            <a 
              href="/admissions" 
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#5e6ad2] text-white font-semibold text-sm hover:opacity-90 transition-opacity shadow-md"
            >
