...
export default function Testimonials13({
  ...
  return (
    <div className="px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      <h2 className="text-[#0f172a]nter font-bold text-[#0f172a]xl tracking-tight md:text-[#0f172a]xl font-heading">
        {title}
      </h2>
      <p className="mt-3 text-[#0f172a]nter text-muted-foreground text-[#0f172a]se md:text-lg font-body max-w-2xl mx-auto">
        {subtitle}
      </p>
