...
export default function Testimonials13({
  ...
  return (
    <div className="px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      <TextEffect as="h2" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="text-[#0f172a]nter font-bold text-[#0f172a]xl tracking-tight md:text-[#0f172a]xl font-heading">
        {title}
      </TextEffect>
      <TextEffect as="p" preset="fade-in-blur" speedReveal={1.1} speedSegment={0.3} className="mt-3 text-[#0f172a]nter text-muted-foreground text-[#0f172a]se md:text-lg font-body max-w-2xl mx-auto">
        {subtitle}
      </TextEffect>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Avatar className="size-10">
                  <AvatarFallback className="bg-[#172554] text-[#F4B400] font-bold text-[#0f172a]se font-heading">
                    {initial}
                  </AvatarFallback>
                </Avatar>
                <div>
              ...
              <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-[#ffffff]mber-400/20 text-[#0f172a]mber-600 font-body">
                Verified
              </span>
            </div>
