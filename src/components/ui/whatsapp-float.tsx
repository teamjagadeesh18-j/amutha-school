...
export function WhatsAppFloat() {
  const message = encodeURIComponent("Hello! I am reaching out from Amutha Matriculation School website to enquire about admissions.");
  const whatsappUrl = "https://wa.me/919942892228?text=" + message;
